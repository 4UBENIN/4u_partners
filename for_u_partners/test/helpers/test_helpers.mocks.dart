...
class _FakeFactureCourse_0 extends _i1.SmartFake implements _i2.FactureCourse {
  _FakeFactureCourse_0(
    Object parent,
...
class _FakeCourseDetail_1 extends _i1.SmartFake implements _i2.CourseDetail {
  _FakeCourseDetail_1(
    Object parent,
    Invocation parentInvocation,
  ) : super(
...
class MockSharedpreferencesService extends _i1.Mock
  ...
  @override
  _i6.Future<void> saveToken(dynamic token) => (super.noSuchMethod(
        Invocation.method(
          #saveToken,
          [token],
        ),
  ...
  @override
  _i6.Future<void> removeToken() => (super.noSuchMethod(
        Invocation.method(
          #removeToken,
          [],
        ),
...
class MockAuthService extends _i1.Mock implements _i9.AuthService {
  ...
  @override
  _i6.Future<void> register(_i11.RegistrationModel? registrationModel) =>
      (super.noSuchMethod(
        Invocation.method(
          #register,
          [registrationModel],
...
///
/// See the documentation for Mockito's code generation for more information.
class MockDriverService extends _i1.Mock implements _i12.DriverService {
  @override
  _i6.Future<void> acceptCourse(int? courseId) => (super.noSuchMethod(
        Invocation.method(
          #acceptCourse,
          [courseId],
        ),
  ...
  @override
  _i6.Future<void> rejectCourse(int? courseId) => (super.noSuchMethod(
        Invocation.method(
          #rejectCourse,
          [courseId],
        ),
  ...
  @override
  _i6.Future<void> startCourse(int? courseId) => (super.noSuchMethod(
        Invocation.method(
          #startCourse,
          [courseId],
        ),
  ...
  @override
  _i6.Future<void> completeCourse(int? courseId) => (super.noSuchMethod(
        Invocation.method(
          #completeCourse,
          [courseId],
        ),
  ...
  @override
  _i6.Future<_i2.FactureCourse> fetchFactureCourse(int? courseId) =>
      (super.noSuchMethod(
        Invocation.method(
          #fetchFactureCourse,
          [courseId],
        ),
        returnValue: _i6.Future<_i2.FactureCourse>.value(_FakeFactureCourse_0(
          this,
          Invocation.method(
            #fetchFactureCourse,
            [courseId],
        ...
        returnValueForMissingStub:
            _i6.Future<_i2.FactureCourse>.value(_FakeFactureCourse_0(
          this,
          Invocation.method(
            #fetchFactureCourse,
            [courseId],
      ...
      ) as _i6.Future<_i2.FactureCourse>);

  @override
  _i6.Future<List<_i2.CoursePendingModel>> fetchCoursesPending() =>
      (super.noSuchMethod(
        Invocation.method(
          #fetchCoursesPending,
          [],
        ),
        returnValue: _i6.Future<List<_i2.CoursePendingModel>>.value(
            <_i2.CoursePendingModel>[]),
        returnValueForMissingStub:
            _i6.Future<List<_i2.CoursePendingModel>>.value(
                <_i2.CoursePendingModel>[]),
      ) as _i6.Future<List<_i2.CoursePendingModel>>);

  @override
  _i6.Future<List<_i2.CourseAssignedItem>> fetchCourses() =>
      (super.noSuchMethod(
        Invocation.method(
          #fetchCourses,
          [],
        ),
        returnValue: _i6.Future<List<_i2.CourseAssignedItem>>.value(
            <_i2.CourseAssignedItem>[]),
        returnValueForMissingStub:
            _i6.Future<List<_i2.CourseAssignedItem>>.value(
                <_i2.CourseAssignedItem>[]),
      ) as _i6.Future<List<_i2.CourseAssignedItem>>);

  @override
  _i6.Future<_i2.CourseDetail> fetchCourseDetail(int? courseId) =>
      (super.noSuchMethod(
        Invocation.method(
          #fetchCourseDetail,
          [courseId],
        ),
        returnValue: _i6.Future<_i2.CourseDetail>.value(_FakeCourseDetail_1(
          this,
          Invocation.method(
            #fetchCourseDetail,
            [courseId],
        ...
        returnValueForMissingStub:
            _i6.Future<_i2.CourseDetail>.value(_FakeCourseDetail_1(
          this,
          Invocation.method(
            #fetchCourseDetail,
            [courseId],
