...
import 'picker_nav_bar_viewmodel.dart';

class PickerNavBarView extends StackedView<PickerNavBarViewModel> {
  const PickerNavBarView({Key? key}) : super(key: key);

  @override
  Widget builder(
    BuildContext context,
    PickerNavBarViewModel viewModel,
    Widget? child,
  ) {
    return Scaffold(
  ...
  @override
  PickerNavBarViewModel viewModelBuilder(
    BuildContext context,
  ) =>
      PickerNavBarViewModel();
}
