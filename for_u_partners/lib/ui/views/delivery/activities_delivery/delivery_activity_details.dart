...
class DeliveryActivityDetails extends StatefulWidget {
  final DeliveryActivityModel? activity;
  const DeliveryActivityDetails({super.key, this.activity});

  @override
  State<DeliveryActivityDetails> createState() =>
      _DeliveryActivityDetailsState();
}

class _DeliveryActivityDetailsState extends State<DeliveryActivityDetails> {
  @override
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Text(
                          _getStatusText(widget.activity!.status),
                          style: TextStyle(
                            color: _getStatusColor(widget.activity!.status),
                            fontSize: 14,
          ...
          GridView.count(
            ...
            children: [
              _buildInfoItem(
                ...
                label: 'Type',
                value: widget.activity!.type.split(' ').length > 1
                    ? widget.activity!.type.split(' ')[1]
                    : widget.activity!.type,
              ),
              _buildInfoItem(
              ...
              if (widget.activity!.totalTime != null)
                _buildInfoItem(
                  icon: Icons.access_time,
                  label: 'Durée',
                  value: widget.activity!.totalTime!,
                ),
              if (widget.activity!.tarifkm != null)
                _buildInfoItem(
                  icon: Icons.monetization_on_outlined,
                  label: 'Tarif/km',
                  value: '${widget.activity!.tarifkm!} CFA',
                ),
            ],
          ),
        ],
