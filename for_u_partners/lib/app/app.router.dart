...
import 'package:for_u_partners/models/document_model.dart' as _i34;
...
class Routes {
  ...
  static const assistanceTechniqueView = '/assistance-technique-view';

  static const statistiquesView = '/statistiques-view';
...
class StackedRouter extends _i1.RouterBase {
  final _routes = <_i1.RouteDef>[
    ...
    _i1.RouteDef(
      Routes.assistanceTechniqueView,
      page: _i30.AssistanceTechniqueView,
    ),
    _i1.RouteDef(
      Routes.statistiquesView,
      page: _i31.StatistiquesView,
    ),
  ];
  ...
  final _pagesMap = <Type, _i1.StackedRouteFactory>{
    ...
    _i30.AssistanceTechniqueView: (data) {
      return _i32.MaterialPageRoute<dynamic>(
        builder: (context) => const _i30.AssistanceTechniqueView(),
        settings: data,
      );
    },
    _i31.StatistiquesView: (data) {
      return _i32.MaterialPageRoute<dynamic>(
        builder: (context) => const _i31.StatistiquesView(),
        settings: data,
      );
    },
  };
...
class ActivitydetailsViewArguments {
  ...
  final _i33.ActivityModel? activity;
...
extension NavigatorStateExtension on _i35.NavigationService {
  ...
  Future<dynamic> navigateToDocumentViewerView({
    _i32.Key? key,
    required _i34.Document document,
    int? routerId,
    bool preventDuplicates = true,
    Map<String, String>? parameters,
    Widget Function(BuildContext, Animation<double>, Animation<double>, Widget)?
  ...
  Future<dynamic> navigateToAssistanceTechniqueView([
    int? routerId,
    bool preventDuplicates = true,
    Map<String, String>? parameters,
    Widget Function(BuildContext, Animation<double>, Animation<double>, Widget)?
    ...
    return navigateTo<dynamic>(Routes.assistanceTechniqueView,
        id: routerId,
        preventDuplicates: preventDuplicates,
        parameters: parameters,
        transition: transition);
  ...
  Future<dynamic> navigateToStatistiquesView([
    int? routerId,
    bool preventDuplicates = true,
    Map<String, String>? parameters,
    Widget Function(BuildContext, Animation<double>, Animation<double>, Widget)?
    ...
    return navigateTo<dynamic>(Routes.statistiquesView,
        id: routerId,
        preventDuplicates: preventDuplicates,
        parameters: parameters,
        transition: transition);
  ...
  Future<dynamic> replaceWithAssistanceTechniqueView([
    int? routerId,
    bool preventDuplicates = true,
    Map<String, String>? parameters,
    Widget Function(BuildContext, Animation<double>, Animation<double>, Widget)?
    ...
    return replaceWith<dynamic>(Routes.assistanceTechniqueView,
        id: routerId,
        preventDuplicates: preventDuplicates,
        parameters: parameters,
        transition: transition);
  ...
  Future<dynamic> replaceWithStatistiquesView([
    int? routerId,
    bool preventDuplicates = true,
    Map<String, String>? parameters,
    Widget Function(BuildContext, Animation<double>, Animation<double>, Widget)?
    ...
    return replaceWith<dynamic>(Routes.statistiquesView,
        id: routerId,
        preventDuplicates: preventDuplicates,
        parameters: parameters,
        transition: transition);
